...
{
    return NetworkRequest::Ptr(new OpenCubeRequest(fileName));
}
...
{
    return NetworkRequest::Ptr(new OpenCubeRequest());
}
...
void OpenCubeRequest::processRequest( ServerCallbackData* data )
{
    assert(data);
