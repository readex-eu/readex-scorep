...
{
    return NetworkRequest::Ptr(new SaveCubeRequest(filename));
}
...
void
SaveCubeRequest::sendResponsePayload(ServerConnection&   connection,
...
void
SaveCubeRequest::receiveResponsePayload(ClientConnection&   connection,
...
{
    return NetworkRequest::Ptr(new SaveCubeRequest());
}
