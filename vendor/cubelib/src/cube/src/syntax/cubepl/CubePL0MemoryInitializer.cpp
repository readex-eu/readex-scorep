...
void
CubePL0MemoryInitializer::memory_setup( cube::Metric* metric, uint32_t met_id )
{
    if ( metric == NULL )
    {
        return;
...
void
CubePL0MemoryInitializer:: memory_setup( cube::Cnode* cnode, uint32_t met_id )
{
...
void
CubePL0MemoryInitializer:: memory_setup( cube::Region* region, uint32_t met_id )
{
...
void
CubePL0MemoryInitializer::memory_setup(  cube::Sysres* sysres, uint32_t met_id )
{
