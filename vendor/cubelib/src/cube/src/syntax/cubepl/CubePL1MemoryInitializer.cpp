...
void
CubePL1MemoryInitializer::memory_setup( cube::Metric* metric, uint32_t met_id )
{
...
void
CubePL1MemoryInitializer:: memory_setup( cube::Cnode* cnode, uint32_t met_id )
{
...
void
CubePL1MemoryInitializer:: memory_setup( cube::Region* region, uint32_t met_id )
{
    cubepl1_memory_manager->put( cubepl1::CALCULATION_REGION_ID, 0,  region->get_id(), met_id, CUBEPL_VARIABLE  );
}

void
CubePL1MemoryInitializer::memory_setup(  cube::Sysres* sysres, uint32_t met_id )
{
