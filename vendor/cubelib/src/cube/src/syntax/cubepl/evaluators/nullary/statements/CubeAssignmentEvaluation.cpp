...
double
AssignmentEvaluation::eval( Cnode* cnode, CalculationFlavour cf, Sysres* sr, CalculationFlavour tf  ) const
{
...
double
AssignmentEvaluation::eval( Cnode* cnode, CalculationFlavour cf ) const
{
