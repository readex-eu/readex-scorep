...
double
VariableEvaluation::eval( Cnode* cnode, CalculationFlavour cf, Sysres* sr, CalculationFlavour tf  ) const
{
...
double
VariableEvaluation::eval( Cnode* cnode, CalculationFlavour cf ) const
{
