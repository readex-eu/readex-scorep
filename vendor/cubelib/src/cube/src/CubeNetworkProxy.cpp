...
void
CubeNetworkProxy::rerootCnode(Cnode& cnode)
{
...
void
CubeNetworkProxy::pruneCnode(Cnode& cnode)
{
...
void
CubeNetworkProxy::setCnodeAsLeaf(Cnode& cnode)
{
...
void
CubeNetworkProxy::setMemoryStrategy(CubeStrategy strategy)
{
