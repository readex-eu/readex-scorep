...
CUBE_TOOL_SRC = ../../../../src/tools/tools/002n.CommonCalltree
...
# Input{
HEADERS += \
   $${CUBE_TOOL_SRC}/commoncalltree_calls.h



SOURCES += \
   $${CUBE_TOOL_SRC}/cube4_commoncalltree.cpp \
   $${CUBE_TOOL_SRC}/commoncalltree_calls.cpp 
