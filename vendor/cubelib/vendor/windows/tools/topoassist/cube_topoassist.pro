...
CUBE_TOOL_SRC = ../../../../src/tools/tools/002f.Topoassist
...
# Input{
HEADERS += \
  $${CUBE_TOOL_SRC}/cube_topoassist.h \
  $${CUBE_TOOL_SRC}/Question.h



SOURCES += \ 
   $${CUBE_TOOL_SRC}/cube4_topoassist.cpp \
   $${CUBE_TOOL_SRC}/Question.cpp 
