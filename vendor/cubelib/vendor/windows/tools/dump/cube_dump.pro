...
CUBE_TOOL_SRC = ../../../../src/tools/tools/002k.Dump
DEPENDPATH += $${COMMON_SRC} $${COMMON_SRC}/common_inc  
INCLUDEPATH += $${CUBE_TOOL_SRC} $${TOOLS_LIBRARY_SRC} $${COMMON_SRC}/common_inc  $${CUBE_SRC}/../../vpath/src/  $${CUBE_SRC}/../  \
...
# Input{
HEADERS += \
   $${CUBE_TOOL_SRC}/cube4_dump_Printer.h \
   $${CUBE_TOOL_SRC}/cube4_dump_GnuPlotPrinter.h \
   $${CUBE_TOOL_SRC}/cube4_dump_GnuPlot2Printer.h \
   $${CUBE_TOOL_SRC}/cube4_dump_CSVPrinter.h \
   $${CUBE_TOOL_SRC}/cube4_dump_CSV2Printer.h \
   $${CUBE_TOOL_SRC}/cube4_dump_CommandOption.h 
   



SOURCES += \
   $${CUBE_TOOL_SRC}/cube4_dump.cpp \
   $${CUBE_TOOL_SRC}/cube4_dump_Printer.cpp \
   $${CUBE_TOOL_SRC}/cube4_dump_GnuPlotPrinter.cpp \
   $${CUBE_TOOL_SRC}/cube4_dump_GnuPlot2Printer.cpp \
   $${CUBE_TOOL_SRC}/cube4_dump_CSVPrinter.cpp \
   $${CUBE_TOOL_SRC}/cube4_dump_CSV2Printer.cpp \
   $${CUBE_TOOL_SRC}/cube4_dump_CommandOption.cpp 
