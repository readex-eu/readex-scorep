...
CUBE_TOOL_SRC = ../../../../src/tools/tools/0040.Tau2Cube
...
# Input{
HEADERS +=   \
$${CUBE_TOOL_SRC}/tau2cube_calls.h \
$${CUBE_TOOL_SRC}/TauProfile.h 


SOURCES += \
   $${CUBE_TOOL_SRC}/tau2cube4.cpp \
   $${CUBE_TOOL_SRC}/TauProfile.cpp 
