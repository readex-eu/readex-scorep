...
/*              PRIVATE CALLS _________________________*/

tar_gnu_header*
__cube_create_tar_header( report_layout_writer* rlw,
                          char*                 filename );

char*
__cube_get_tared_cube_name( char* cubename );
void
__cube_tar_finish( report_layout_writer* rlw );
void
__cube_set_size_and_calculate_checksum( tar_gnu_header* header,
                                        uint64_t        size );

void
__cube_tar_file_finish( report_layout_writer* rlw,
                        uint64_t              size );
