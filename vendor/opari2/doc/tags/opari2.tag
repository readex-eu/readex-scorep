...
<tagfile>
  <compound kind="file">
    ...
    <path>/home/rschoene/tmp/TRY_READEX_online_access_call_tree_extensions/vendor/opari2/src/opari-lib-dummy/</path>
    <filename>opari2__region__info_8h</filename>
    <class kind="struct">OPARI2_Region_info</class>
  </compound>
  <compound kind="file">
    <name>pomp2_lib.h</name>
    <path>/home/rschoene/tmp/TRY_READEX_online_access_call_tree_extensions/vendor/opari2/include/opari2/</path>
