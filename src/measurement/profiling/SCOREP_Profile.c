...
write( void )
{
    ...
    {
        scorep_profile_write_cube4( SCOREP_PROFILE_OUTPUT_CUBE4 );
    }
    ...
    {
        scorep_profile_write_cube4( SCOREP_PROFILE_OUTPUT_CUBE_TUPLE );
    }
    else if ( scorep_profile_output_format & SCOREP_PROFILE_OUTPUT_THREAD_SUM )
    {
        scorep_profile_write_cube4( SCOREP_PROFILE_OUTPUT_THREAD_SUM );
    }
    else if ( scorep_profile_output_format & SCOREP_PROFILE_OUTPUT_THREAD_TUPLE )
    {
        scorep_profile_write_cube4( SCOREP_PROFILE_OUTPUT_THREAD_TUPLE );
    }
    else
    {
