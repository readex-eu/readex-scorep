...
typedef enum SCOREP_Substrates_EventType
{
    ...
    SCOREP_EVENT_ADD_TUNING_ACTION,
    SCOREP_EVENT_GENERIC_COMMAND,
...
typedef void ( * SCOREP_Substrates_AddTuningActionCb )(
    uint32_t regionId,
    uint8_t  kind,
    char*    actionName,
    int      value );

typedef void ( * SCOREP_Substrates_GenericCommandCb )(
    const char* command,
    size_t      bytes );
